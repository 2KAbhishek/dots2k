...
alias scr="scrot -cd 3 -F ~/Pictures/Screenshots/snap-%Y-%m-%d"
alias scrw="scrot -u -bcd 3 -F ~/Pictures/Screenshots/snap-%Y-%m-%d"
alias scrs="scrot -s -l width=3,color='#1688f0',mode=edge,opacity=90 -F ~/Pictures/Screenshots/snap-%Y-%m-%d"
