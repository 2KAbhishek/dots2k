...
POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(os_icon context dir vcs direnv asdf rspec_stats time)
POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(status vi_mode command_execution_time_joined background_jobs ram_joined battery)
