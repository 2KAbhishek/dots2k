...
| Keybinding                       | Action                     |
| -------------------------------- | -------------------------- |
| <kbd>Alt</kbd> + <kbd>b/f</kbd>  | Backward / Forward word    |
| <kbd>Alt</kbd> + <kbd>d</kbd>    | Run [dexe][2] launcher     |
| <kbd>Alt</kbd> + <kbd>e</kbd>    | fzf search toggle          |
| <kbd>Alt</kbd> + <kbd>g</kbd>    | Lazygit                    |
| <kbd>Alt</kbd> + <kbd>m</kbd>    | Copy last word             |
| <kbd>Alt</kbd> + <kbd>n</kbd>    | Show all [tdo][3] notes    |
| <kbd>Alt</kbd> + <kbd>r</kbd>    | Reload config              |
| <kbd>Alt</kbd> + <kbd>t</kbd>    | Open [tmux-tea][1]         |
